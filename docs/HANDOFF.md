...
- On 17 July 2026, Costway France was removed from the active production registry and retained as a deferred adapter because the HTTP 403 persisted. Production verification returned 46 sites and zero stale sites: `fr:Costway France` was absent, while Costway NL remained active, healthy, and unaffected.
