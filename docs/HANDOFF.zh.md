...
- 2026 年 7 月 17 日，因 HTTP 403 持续出现，Costway France 已从生产活跃注册表移除，适配器代码保留为 deferred。生产验证返回 46 个站点、0 个 stale 站点：`fr:Costway France` 已不存在，Costway NL 仍正常启用、状态健康且不受影响。
